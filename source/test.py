...
# image = cv2.imread(r"number_plates_image\blur_images\xemay192_jpg.rf.8a4a674ef56d61744b627ac8f631b2c3.jpg")
# orig_image = image.copy()
# orig_image = cv2.resize(orig_image, (224, 224))
# cv2.imwrite(f"outputs/test_deblurred_images/original_blurred_mihir.jpg", orig_image)
...
# with torch.no_grad():
#     outputs = model(image)
#     save_decoded_image(outputs.cpu().data, name=f"outputs/test_deblurred_images/deblurred_mihir.jpg")
